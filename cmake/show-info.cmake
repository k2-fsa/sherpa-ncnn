...
if(Git_FOUND)
  execute_process(COMMAND
    ...
    OUTPUT_VARIABLE SHERPA_NCNN_GIT_SHA1
  ...
  execute_process(COMMAND
    ...
    WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
    OUTPUT_VARIABLE SHERPA_NCNN_GIT_DATE
    ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE
  )
  message(STATUS "sherpa-ncnn git sha1: ${SHERPA_NCNN_GIT_SHA1}")
  message(STATUS "sherpa-ncnn git date: ${SHERPA_NCNN_GIT_DATE}")
else()
...
if(UNIX AND NOT APPLE)
  execute_process(COMMAND
    lsb_release -sd
    OUTPUT_VARIABLE SHERPA_NCNN_OS
...
elseif(APPLE)
  ...
  set(SHERPA_NCNN_OS "${_product_name} ${_product_version} ${_build_version}")
elseif(WIN32)
  ...
  if(NOT SHERPA_NCNN_OS)
    ...
    if(_cmd_out)
      set(SHERPA_NCNN_OS "Windows ${_cmd_out}")
    else()
      set(SHERPA_NCNN_OS "Windows (version unknown)")
    endif()
  endif()
else()
  set(SHERPA_NCNN_OS "Unknown")
endif()
message(STATUS "OS used to build sherpa-ncnn: ${SHERPA_NCNN_OS}")
