...
wget https://github.com/k2-fsa/sherpa-ncnn/releases/download/tts-models/ncnn-vits-piper-en_US-bryce-medium-fp16.tar.bz2
tar xvf ncnn-vits-piper-en_US-bryce-medium-fp16.tar.bz2
rm ncnn-vits-piper-en_US-bryce-medium-fp16.tar.bz2
"""
import time
...
def create_tts():
    model_dir = "ncnn-vits-piper-en_US-bryce-medium-fp16"
